mutable struct CRT
    ...
    function CRT()
        ...
        Base.@threadcall((:mbedtls_x509_crt_init, libmbedx509), Cvoid, (Ptr{Cvoid},), c.data)
        finalizer(c->begin
...
function crt_info(crt::CRT)
    ...
    Base.@threadcall((:mbedtls_x509_crt_info, libmbedx509), Cint,
...
function crt_parse!(chain, buf::String)
    ret = Base.@threadcall((:mbedtls_x509_crt_parse, libmbedx509), Cint,
