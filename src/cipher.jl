...
mutable struct Cipher
    ...
    function Cipher()
        ...
        Base.@threadcall((:mbedtls_cipher_init, libmbedcrypto), Cvoid,
            (Ptr{Cvoid},), ctx.data)
...
function CipherInfo(name::AbstractString)
    ptr = Base.@threadcall((:mbedtls_cipher_info_from_string, libmbedcrypto), Ptr{Cvoid},
        (Cstring,), String(name))
...
function CipherInfo(kind::CipherKind)
    ptr = Base.@threadcall((:mbedtls_cipher_info_from_type, libmbedcrypto), Ptr{Cvoid},
        (Cint,), Int(kind))
...
function CipherInfo(id::CipherID, key_bitlen, mode::CipherMode)
    ptr = Base.@threadcall((:mbedtls_cipher_info_from_values, libmbedcrypto), Ptr{Cvoid},
...
function Cipher(info::CipherInfo)
    cipher = Cipher()
    @err_check Base.@threadcall((:mbedtls_cipher_setup, libmbedcrypto), Cint,
...
function get_key_bitlen(cipher::Cipher)
    ret = Base.@threadcall((:mbedtls_cipher_get_key_bitlen, libmbedcrypto), Cint,
...
function set_key!(cipher::Cipher, key, op::Operation)
    ...
    @err_check Base.@threadcall((:mbedtls_cipher_setkey, libmbedcrypto), Cint,
...
function set_padding_mode!(cipher::Cipher, padding::Padding)
    @err_check Base.@threadcall((:mbedtls_cipher_set_padding_mode, libmbedcrypto), Cint,
        (Ptr{Cvoid}, Cint), cipher.data, Int(padding))
end

function set_iv!(cipher::Cipher, iv)
    iv_b = tobytes(iv)
    @err_check Base.@threadcall((:mbedtls_cipher_set_iv, libmbedcrypto), Cint,
...
function update!(cipher::Cipher, buf_in, buf_out)
    ...
    @err_check Base.@threadcall((:mbedtls_cipher_update, libmbedcrypto), Cint,
...
function finish!(cipher::Cipher, buf_out)
    out_ref = Ref{Csize_t}(sizeof(buf_out))
    @err_check Base.@threadcall((:mbedtls_cipher_finish, libmbedcrypto), Cint,
...
function crypt!(cipher::Cipher, iv, buf_in, buf_out)
    ...
    buf_in_b = tobytes(buf_in)
    @err_check Base.@threadcall((:mbedtls_cipher_crypt, libmbedcrypto), Cint,
